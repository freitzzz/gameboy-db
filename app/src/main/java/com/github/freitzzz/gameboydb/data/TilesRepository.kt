package com.github.freitzzz.gameboydb.data
    ...
    override suspend fun top(): List<GameTile> {
        return arrayListOf(
            GameTile(
                ...
                rating = 9.3f,
                cover = "https://static.wikia.nocookie.net/nintendo/images/5/59/Pokemon_Red_%28NA%29.png/revision/latest/scale-to-width-down/1000?cb=20240413173729&path-prefix=en",
